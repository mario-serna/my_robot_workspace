...
(cl:in-package principiante_tutoriales-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name principiante_tutoriales-msg:<Num> is deprecated: use principiante_tutoriales-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader principiante_tutoriales-msg:num-val is deprecated.  Use principiante_tutoriales-msg:num instead.")
  (num m))

...
struct nodeState_
{
  ...
  _node_state_desc_type node_state_desc;
   ...
   typedef float _node_state_time_type;
  _node_state_time_type node_state_time;
  ...
  _bug_state_desc_type bug_state_desc;
   ...
   typedef float _bug_state_time_type;
  _bug_state_time_type bug_state_time;
...
struct MD5Sum< ::bug_algorithms::nodeState_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xeacf4f1a4f8ef654ULL;
  static const uint64_t static_value2 = 0xfd25492c527c277fULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::bug_algorithms::nodeState_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.node_state_time);
      stream.next(m.bug_state);
      stream.next(m.bug_state_desc);
      stream.next(m.bug_state_time);
    }
...
struct Printer< ::bug_algorithms::nodeState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::bug_algorithms::nodeState_<ContainerAllocator>& v)
  {
    ...
    s << indent << "node_state_time: ";
    Printer<float>::stream(s, indent + "  ", v.node_state_time);
    s << indent << "bug_state: ";
    ...
    s << indent << "bug_state_time: ";
    Printer<float>::stream(s, indent + "  ", v.bug_state_time);
  }
};

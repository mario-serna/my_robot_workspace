...
(cl:defmethod time-val ((m <algorithmState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader bug_algorithms-msg:time-val is deprecated.  Use bug_algorithms-msg:time instead.")
  (time m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<algorithmState>)))
  ...
  "6f90eba9625cb29111498ea4fb81eca4")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'algorithmState)))
  "Returns md5sum for a message object of type 'algorithmState"
  "6f90eba9625cb29111498ea4fb81eca4")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<algorithmState>)))
  ...
  (cl:format cl:nil "uint8 algorithm~%string name~%float32 pose_x~%float32 pose_y~%float32 yaw~%float32 initial_to_goal_distance~%float32 current_to_goal_distance~%float32 best_distance~%float32 path_length~%float32 time~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'algorithmState)))
  "Returns full string definition for message of type 'algorithmState"
  (cl:format cl:nil "uint8 algorithm~%string name~%float32 pose_x~%float32 pose_y~%float32 yaw~%float32 initial_to_goal_distance~%float32 current_to_goal_distance~%float32 best_distance~%float32 path_length~%float32 time~%~%~%"))
